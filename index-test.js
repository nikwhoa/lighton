...
cron.schedule('*/1 * * * *', async function () {
    ...
    // count difference between two timestamps

    let trueTS = db.data.trueTS;
    let falseTS = db.data.falseTS;
    ...
    console.log(days + " днів, " + hours + " годин, " + minutes + " хвилин");
    ...
    if (lightData.lighton) {
        ...
        db.data.lighton = days + " днів, " + hours + " годин, " + minutes + " хвилин"
    } else {
        let d1 = db.data.falseTS
        let d2 = lightData.timestamp
        db.data.trueTS = lightData.timestamp
        db.data.statusBar = false
        db.data.lightoff = days + " днів, " + hours + " годин, " + minutes + " хвилин"
